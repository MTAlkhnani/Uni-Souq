    ...
    return LayoutBuilder(builder: (context, constraints) {
      return OrientationBuilder(builder: (context, orientation) {
        SizeUtils.setScreenSize(
            ...
            orientation); // Initialize SizeUtils
...
class SizeUtils {
  ...
  static double defaultWidth = FIGMA_DESIGN_WIDTH;
  static double defaultHeight = FIGMA_DESIGN_HEIGHT;
  ...
  static void setScreenSize(
    ...
    if (orientation == Orientation.portrait) {
      width = screenWidth.isNonZero(defaultValue: defaultWidth);
      height = screenHeight.isNonZero(defaultValue: defaultHeight);
    } else {
      width = screenHeight.isNonZero(defaultValue: defaultWidth);
      height = screenWidth.isNonZero(defaultValue: defaultHeight);
    }
